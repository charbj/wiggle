...
class cryoDRGN:
    def add_args(parser):
        ...
        parser.add_argument('--prefix', default='vol_',
        ...
        group.add_argument('--Apix', type=float, default=1,
    ...
    def main(args):
        ...
        print("cfg begin")
        cfg = overwrite_config(config, args)

        D = cfg['lattice_args']['D']  # image size + 1
        zdim = cfg['model_args']['zdim']
        norm = cfg['dataset_args']['norm']

        print("Load from HetOnlyVAE")
